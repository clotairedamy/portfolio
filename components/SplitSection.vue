...
<div class="relative bg-red-800">
  <div class="absolute inset-0" aria-hidden="true">
    <div class="absolute inset-y-0 right-0 w-1/2 bg-red-800"></div>
  </div>
  <div class="relative max-w-screen-xl mx-auto lg:px-8 lg:grid lg:grid-cols-2">
    <div class="bg-red-800 py-16 px-4 sm:py-24 sm:px-6 lg:px-0 lg:pr-8">
    ...
    <div class="bg-red-800 py-16 px-4 sm:py-24 sm:px-6 lg:bg-none lg:px-0 lg:pl-8 lg:flex lg:items-center lg:justify-end">
      <div class="max-w-lg mx-auto w-full space-y-8 lg:mx-0">
        ...
        <ul class="bg-yellow-600  rounded sm:grid sm:grid-cols-2 sm:grid-rows-3 sm:grid-flow-col">
